...
# Download and read PDF files from GitHub
def load_pdfs():
    docs = []
    for folder in FOLDER_NAMES:
        folder_path = f"Printrove/{folder}"
        api_url = f"https://api.github.com/repos/SampleAIProjects/customer_service/contents/{folder_path}"
...
# Streamlit UI
st.set_page_config(page_title="📚 Printrove Customer Support Chatbot")
st.title("🤖 Printrove AI Chatbot")
